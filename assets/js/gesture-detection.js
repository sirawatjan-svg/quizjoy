...
// v4 (ก.ย. 2026): เพิ่มจาก 0.07 → 0.10 — ทุกภาพหน้าจอวินิจฉัยที่ครูส่งมาตลอดหลายรอบ (แม้หลัง calibration
// scale/indexPoint/debounce ทุกอย่างข้างล่างนี้ทำงานแล้ว) ยังเห็นจุดติดตามมือ (จุดเขียว) ค้างใกล้เส้นแบ่ง
// กลางระหว่างกล่องคำตอบซ้ำๆ อยู่ดี — ครูรายงานล่าสุดว่ายังกดผิดแบบเดิม แปลว่า margin เดิม (0.07 เทียบกับ
// REFERENCE_SPAN 0.25 ที่ scale ไปหา = แค่ 28% ของระยะเอื้อมทั้งหมด) แคบเกินไปสำหรับ noise จริงที่เหลืออยู่
// หลังแก้จุดอื่นหมดแล้ว ขยับเป็น 0.10 (40% ของระยะเอื้อม) ให้เผื่อ noise ได้มากขึ้นชัดเจน แลกกับต้องชี้ให้
// ขาดออกจากกึ่งกลางมากขึ้นอีกนิดกว่าจะสลับโซนได้ (ยอมรับได้ เพราะตอบผิดเสียหายกว่าหน่วงนิดหน่อย)
...
// v4 (ก.ย. 2026): เพิ่มจาก 130 → 180ms คู่กับการขยาย HYSTERESIS_MARGIN ด้านบน — เหตุผลเดียวกัน (ยังมี
// เคสกดผิดหลงเหลือจากภาพวินิจฉัยล่าสุด) ให้เวลาเผื่อมากขึ้นอีกนิดก่อนยอมเชื่อว่าโซนใหม่ที่เห็นคือของจริง
// ไม่ใช่ blip จากมือกำ/ขยับผ่าน ยังไม่ถึงขั้นรู้สึกหน่วงชัดเจน (ยังเร็วกว่า holdMs 1400ms มาก)
const ZONE_CHANGE_CONFIRM_MS = 180;
