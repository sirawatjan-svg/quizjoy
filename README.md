...
- [ ] เปิด GitHub Pages ให้เว็บ live จริงที่ `sirawatjan-svg.github.io/quizjoy` — **ยังไม่ทำ เพราะมีจุดที่ควรแก้ก่อน
      เปิดสาธารณะ**: หน้า `teacher/login.html` มีโหมด "สมัครครั้งแรก" ที่เปิดให้ใครก็สมัครเป็นครูได้เอง ถ้าเว็บ
      live ใครก็สามารถกดสมัครแล้วได้สิทธิ์เขียนคลังข้อสอบ/สร้างห้องทันที ควรปิดโหมดสมัครเองก่อน deploy จริง
      (เช่น เอาปุ่มออกหลังสมัครบัญชีจริงเสร็จแล้ว)
