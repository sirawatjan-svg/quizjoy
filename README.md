...
**อัปเดตหลังทดสอบจริงในห้องเรียน**: แก้บั๊ก zone-selection ไม่นิ่ง (เจอว่า dead-zone code เดิมเป็น no-op จริงๆ
ใส่ hysteresis ที่ทำงานจริงแทน — ดู `test/gesture-hysteresis-selftest.html`), ขยายกล่องคำถาม/ย่อกล่องคำตอบ,
เปลี่ยนเกม "6-7" จากชี้ซ้าย-ขวาเป็นยกมือขึ้น-ลง (ตรงกับเทรนด์จริงมากขึ้น), และเกม "ตามท่ามือ" ทำให้ลำดับสั้นลง
+ มี progress badge กันงง
